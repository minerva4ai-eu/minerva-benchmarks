...
#######################################################
FRAMEWORKS=("vllm" "sglang")    # Add other frameworks if needed
DATASETS=("sharegpt" "sonnet")  # Add more datasets if needed
MODELS=("Llama-3.1-8B-Instruct" "gemma-3-12b-it" "Mistral-7B-Instruct-v0.3" "Llama-3.3-70B-Instruct" "Llama-3.1-405B") # Add your models here
