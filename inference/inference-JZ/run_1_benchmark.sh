...
#######################################################
GPUS_PER_NODE=4
FRAMEWORKS=("vllm" "deepspeed") #deepspeed ou vllm)    # Add other frameworks if needed
DATASETS=("sonnet" "sharegpt")  # Add more datasets if needed
MODELS=("gemma-3-12b-it") # ("Llama-3.1-405B" "gemma-3-12b-it" "Mistral-7B-Instruct-v0.3") # Add your models here
