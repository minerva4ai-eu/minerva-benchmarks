...
# PROFILER_DIR = f"profiler/{os.environ['SLURM_JOB_ID']}.{os.environ.get('SLURM_STEP_ID', '0')}/{os.environ['SLURM_NODEID']}-{os.environ['SLURM_NODENAME']}"
PROFILER_PREFIX_PATH = os.getenv("PROFILER_PREFIX_PATH", "")
PROFILER_DIR = os.getenv("PROFILER_DIR", "")
