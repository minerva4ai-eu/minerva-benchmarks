...
#######################################################
FRAMEWORKS=("deepspeed")   # ("torchrun" "accelerate" "deepspeed")    # Add other frameworks if needed
DATASETS=("alpaca")      # ("alpaca" "squad") # Add more datasets if needed
MODELS=("Llama-3.3-70B-Instruct") # Llama-3.1-8B") # "Mistral-7B-Instruct-v0.3" "Llama-3.3-70B-Instruct" "gemma-3-1b-it") # Add your models here
NUMBER_OF_NODES=(8)
TYPE_PARALLELISM=("zero3")
